...
const category = getCategoryById("generator")!;
...
export default function GeneratorToolsPage() {
  const tools = getToolsByCategory("generator");
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <Breadcrumb items={[{ name: category.name, href: category.path }]} />
      <h1 className="text-3xl font-bold text-text mb-2">{category.icon} {category.name}</h1>
